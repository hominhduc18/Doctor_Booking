import 'package:doctorbooking/shared/theme/utils/time_of_day_extensions.dart';
import 'package:doctorbooking/shared/theme/widgets/buttons/app_icon_button.dart';
import 'package:doctorbooking/shared/theme/widgets/card/doctor_card.dart';
...
class DoctorDetailsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<DoctorDetailsBloc, DoctorDetailState>(
        builder: (context, state) {
          if (state.status == DoctorDetailStatus.initial ||
              state.status == DoctorDetailStatus.loading) {
